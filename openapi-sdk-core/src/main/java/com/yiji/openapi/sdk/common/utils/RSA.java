...
public class RSA {
	...
	public static String signBase64(@NotNull String data) {
		PrivateKey privateKey = RSA.loadPrivateKeyFromKeyStore(ApiSdkConstants.RSA_PFX_URL, RSA.KEY_STORE_PKCS12,
			ApiSdkConstants.RSA_PFX_PASSWORD);
	...
	public static boolean verifyBase64(String text, String signBase64) {
		PublicKey publicKey = RSA.loadPublicKeyFromCert(ApiSdkConstants.RSA_CER_URL);
	...
	public static String encryptByPublicKeyBase64(String plainText, String charset) {
		PublicKey publicKey = RSA.loadPublicKeyFromCert(ApiSdkConstants.RSA_CER_URL);
	...
	public static String decryptByPrivateKeyBase64(String encryptedBase64, String charset) {
		PrivateKey privateKey = RSA.loadPrivateKeyFromKeyStore(ApiSdkConstants.RSA_PFX_URL, RSA.KEY_STORE_PKCS12,
			ApiSdkConstants.RSA_PFX_PASSWORD);
		return decryptByPrivateKeyBase64(encryptedBase64, privateKey, charset);
	}
	 ...
	 * @return
	 */
	public static PublicKey loadPublicKeyFromKeyStore(String keystoreUri, String keystoreType, String keystorePassword) {
		InputStream in = null;
		try {
			KeyStore keyStore = KeyStore.getInstance(keystoreType);
			Resource resource = new DefaultResourceLoader().getResource(keystoreUri);
