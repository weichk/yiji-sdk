...
/*
 * 修订记录：
 * lvchen@yiji.com 2014年8月6日 下午4:21:40 创建
 */
 ...
 * 
 */
@OpenApiMessage(service = "guaranteePayConfirm", type = ApiMessageType.Response)
public class GuaranteePayConfirmResponse extends ApiResponse {
	@OpenApiField
