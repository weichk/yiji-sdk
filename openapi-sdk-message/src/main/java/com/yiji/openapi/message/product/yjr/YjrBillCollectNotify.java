...
/*
 * 修订记录:
 * hgeshu@yiji.com 2015-06-25 09:49 创建
 *
 */
 ...
 */
@OpenApiMessage(service = "yjrBillCollect", type = ApiMessageType.Notify)
public class YjrBillCollectNotify extends ApiNotify {
	/**
	 * 易极付交易流水号
	 */
