...
/*
 * 修订记录:
 * xiyang@yiji.com 2015-01-30 17:11 创建
 *
 */
 ...
 */
@OpenApiMessage(service = "yzzAutoTenderPayment", type = ApiMessageType.Notify)
public class YzzAutoTenderPaymentNotify extends ApiNotify {
