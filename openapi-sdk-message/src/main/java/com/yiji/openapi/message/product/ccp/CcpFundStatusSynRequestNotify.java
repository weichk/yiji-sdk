...
/*
 * 修订记录：
 * zhike 2016年3月31日 上午10:44:30 创建
 */
 ...
 * @data 2016年3月31日
 */
@OpenApiMessage(service = "ccpFundStatusSyn", type = ApiMessageType.Notify)
public class CcpFundStatusSynRequestNotify extends ApiNotify {
	@NotBlank
