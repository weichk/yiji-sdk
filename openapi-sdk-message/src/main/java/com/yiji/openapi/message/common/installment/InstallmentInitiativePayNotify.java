...
/*
 * 修订记录:
 * hgeshu@yiji.com 2015-06-26 15:09 创建
 *
 */
 ...
 */
@OpenApiMessage(service = "installmentInitiativePay", type = ApiMessageType.Notify)
public class InstallmentInitiativePayNotify extends ApiNotify {
