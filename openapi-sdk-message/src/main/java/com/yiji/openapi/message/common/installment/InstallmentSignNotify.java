 ...
 */
@OpenApiMessage(service = "installmentSign", type = ApiMessageType.Notify)
public class InstallmentSignNotify extends ApiNotify {
	...
	@OpenApiField(desc = "代扣状态")
	private String status;
	
	@OpenApiField(desc = "备注")
	private String memo;
	
	@OpenApiField(desc = "分期订单号")
	private String installmentOrderNo;

	@OpenApiField(desc = "签约状态",constraint = "SUCCESS：签约成功<br>UPAYSIGN_FAIL：主卡异步签约失败<br>STANDBY_UPAYSIGN_FAIL：备卡异步签约失败")
	private String signStatus;

	@OpenApiField(desc = "错误码")
	private String errorCode;

	@OpenApiField(desc = "描述",constraint = "错误码的描述或者签约结果的描述")
