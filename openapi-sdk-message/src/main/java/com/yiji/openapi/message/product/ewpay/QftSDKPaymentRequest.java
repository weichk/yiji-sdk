...
/*
 * 修订记录：
 * @author xinqing@yiji.com 上午9:54:32 创建
 */
 ...
 *
 */
@OpenApiMessage(service = "qftSDKPayment", type = ApiMessageType.Request)
public class QftSDKPaymentRequest extends ApiRequest {
	/** 外部软件商号 */
	@Length(max=50)
