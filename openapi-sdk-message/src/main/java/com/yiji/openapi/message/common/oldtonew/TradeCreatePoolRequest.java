 ...
 */
@Deprecated
@OpenApiMessage(service = "tradeCreatePool", type = ApiMessageType.Request)
public class TradeCreatePoolRequest extends ApiRequest {
    ...
    @OpenApiField(desc = "流程产品", constraint = "{\"data\":[\"bankcard_to_bankcard:卡到卡\",\"commonEscowTrade:通用担保交易\",\"deductDepoisital:代扣充值\",\"deductTransferWithdraw:代扣转账提现交易\",\"escowTrade:担保交易\",\"fastpay:即时到账\",\"fastpayRefund:即时到账有退款\",\"freezeEscow:冻结担保\",\"freeze_escow_with_sub_trade:有子交易的冻结担保\",\"pool:流标集资\",\"poolReverse:集资的还款\",\"poolTogether:给力集资\",\"remittance:汇付\",\"remittanceV2:汇付二期\",\"transfer:站内转帐\",\"transfer_to_bankcard_v2:转账到卡\",\"transfertobankcard:转账到卡\"],\"name\":\"流程产品\"}", demo = "20130812020055285248")
    private String product;

    @NotBlank
    @OpenApiField(desc = "交易类型", constraint = "{\"data\":[\"ESCROWTRADE:担保交易\",\"FASTPAYTRADE:即时到账交易\",\"POOL:集资借款\",\"POOL_REVERSE:集资还款\",\"POOL_TOGETHER:给力式集资\",\"transferTobank:转账到卡\",\"bankcardTransfer:卡到卡\",\"deductDepoisital:代扣充值\",\"transfer:站内转帐\",\"BEHALF_DEPOISIT:代充\",\"OTHER:其他\"],\"name\":\"交易类型\"}", demo = "20130812020055285248")
    ...
    @OpenApiField(desc = "币种", constraint = "默认人民币", demo = "CNY")
	...
	private List<GoodsClause> goods = new LinkedList<GoodsClause>();

    @OpenApiField(desc = "业务产品编号",demo = "20140516other")
