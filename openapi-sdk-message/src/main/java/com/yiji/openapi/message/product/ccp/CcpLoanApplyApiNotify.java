...
/*
 * 
 * mdaheng@yiji.com 2016-03-31 14:43 创建
 *
 */
 ...
 * @since 2016-03-31
 */
@OpenApiMessage(service = "ccpLoanApply", type = ApiMessageType.Notify)
public class CcpLoanApplyApiNotify extends ApiNotify {
	@NotBlank
	...
	@OpenApiField(desc = "拟放款金额", constraint = "拟放款金额", demo = "50000000")
