 ...
 * @data 2016年4月29日
 */
@OpenApiMessage(service = "paymentUnbinding", type = ApiMessageType.Response)
public class PaymentUnbindingResponse extends ApiResponse {
	@NotBlank
