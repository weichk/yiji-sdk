 ...
 * 
 */
@OpenApiMessage(service = "ebankGatewayDeposit", type = ApiMessageType.Notify)
public class EBankDepositGatewayNotify extends ApiNotify {
	
	@OpenApiField(desc = "充值流水号",demo = "1234567498")
