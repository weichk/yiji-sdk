 ...
 *
 */
@OpenApiMessage(service = "tradePayPoolTogether", type = ApiMessageType.Response)
public class TradePayPoolTogetherResponse extends ApiResponse {
	...
	@OpenApiField(desc = "交易简单信息", demo = "XXX")
	private List<TradeSimpleApiInfo> info;

	@OpenApiField(desc = "特殊返回数据集", demo = "XXX")
