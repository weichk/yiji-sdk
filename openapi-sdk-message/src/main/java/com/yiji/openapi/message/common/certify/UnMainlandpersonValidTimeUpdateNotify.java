...
/*
 * 修订记录：
 * zhike 2015年9月10日 上午10:53:13 创建
 */
 ...
 */
@Deprecated
@OpenApiMessage(service = "unMainlandpersonValidTimeUpdate", type = ApiMessageType.Notify)
public class UnMainlandpersonValidTimeUpdateNotify extends ApiNotify{
	@NotBlank
