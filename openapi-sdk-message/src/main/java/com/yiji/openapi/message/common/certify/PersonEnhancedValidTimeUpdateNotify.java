...
/*
 * 修订记录：
 * zhike 2015年9月10日 上午11:07:10 创建
 */
...
@Deprecated
@OpenApiMessage(service = "personEnhancedValidTimeUpdate", type = ApiMessageType.Notify)
public class PersonEnhancedValidTimeUpdateNotify extends ApiNotify {
	@NotBlank
