...
/*
 * 修订记录:
 * hgeshu@yiji.com 2015-07-10 14:44 创建
 *
 */
 ...
 */
@OpenApiMessage(service = "commonRedirectToGR", type = ApiMessageType.Response)
public class CommonRedirectToGRResponse extends ApiResponse {
    /** 登陆名 */
