 ...
 */
@OpenApiMessage(service = "openPaymentAccount", type = ApiMessageType.Response)
public class OpenPaymentAccountResponse extends ApiResponse {
    ...
    @OpenApiField(desc = "特许经营许可证二",demo = "http://www.yiji.com/1.jpg",constraint = "企业/个体户可传入该参数")
    private String specialBusinessSecond;
    ...
    public String getSpecialBusinessSecond() {
        return specialBusinessSecond;
    }

    public void setSpecialBusinessSecond(String specialBusinessSecond) {
        this.specialBusinessSecond = specialBusinessSecond;
    }
