...
public class WithdrawQueryResponse extends ApiResponse {
	 ...
	 * @param memo
	 */
	public WithdrawQueryResponse(Date payTime, String userId, String payNo, String outBizNo, String accountNo,
									String accountName, String bankName, String bankAccountNo, Money amount,
									Money charge, Money balance, Money totoalAmount, String status,
									String memo) {
		super();
