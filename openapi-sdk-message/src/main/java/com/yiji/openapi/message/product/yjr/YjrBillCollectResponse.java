...
/*
 * 修订记录:
 * hgeshu@yiji.com 2015-06-25 09:33 创建
 *
 */
 ...
 */
@OpenApiMessage(service = "yjrBillCollect", type = ApiMessageType.Response)
public class YjrBillCollectResponse extends ApiResponse {
	/**
	 * 易极付交易流水号
	 */
